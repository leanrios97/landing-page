...
import { Quote, Star, Plus, ChevronLeft, ChevronRight, ArrowLeft, Linkedin } from "lucide-react"
...
export default function ReseniasPage() {
  ...
  const limit = 10 // Mostramos más reseñas por página en la vista completa
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0A192F]">
      <div className="container mx-auto px-4 py-16">
        <div className="mb-8">
          <Link href="/#testimonios" className="inline-flex items-center text-[#00B8D9] hover:underline mb-6">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Volver al inicio
          </Link>
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-[#00B8D9] hover:bg-[#00B8D9]/80 text-white">Reseñas</Badge>
            <h1 className="text-4xl font-bold mb-4">Todas las Reseñas</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Experiencias compartidas por clientes que han confiado en mis servicios
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Tarjeta para añadir una nueva reseña - siempre visible en la parte superior */}
              <Card
